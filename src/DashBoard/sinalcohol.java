 ...
 * @author USUARIO
 */
public class sinalcohol extends javax.swing.JFrame {

    /**
     * Creates new form sinalcohol
     */
    public sinalcohol() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(sinalcohol.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new sinalcohol().setVisible(true);
            }
        });
    }
