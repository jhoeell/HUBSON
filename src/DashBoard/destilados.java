 ...
 * @author USUARIO
 */
public class destilados extends javax.swing.JFrame {

    /**
     * Creates new form destilados
     */
    public destilados() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(destilados.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new destilados().setVisible(true);
            }
        });
    }
